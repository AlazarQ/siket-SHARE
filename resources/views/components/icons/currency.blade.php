<svg {{ $attributes }} width="256px" height="256px" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#c9b0b0">
    ...
    <g id="SVGRepo_iconCarrier">
        <path
            ...
            stroke="#7f7a7a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
    </g>
</svg>
